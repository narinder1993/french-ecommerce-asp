...
<br /><br /><br /><br />
    <div class="account">
        ...
        <table style="font-size: large">
                        <tr style="height:55px"><td style="width:300px">Name</td><td style="height:40px; "><asp:TextBox style="height:40px" ID="nameTxt" runat="server"></asp:TextBox> <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Required Field" ControlToValidate="nameTxt"></asp:RequiredFieldValidator></td></tr>
                        ...
                        <tr style="height:55px"><td>Phone</td><td style="height:40px"><asp:TextBox style="height:40px" ID="phoneTxt" runat="server"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Required Field " ControlToValidate="phoneTxt"></asp:RequiredFieldValidator></td></tr>
                        <tr style="height:55px"><td>Street Address I</td><td style="height:40px"><asp:TextBox style="height:100px" ID="addressTxt" runat="server" TextMode="MultiLine"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Required Field" ControlToValidate="addressTxt"></asp:RequiredFieldValidator></td></tr>
                        <tr style="height:55px"><td>City</td><td style="height:40px"><asp:TextBox style="height:40px" ID="cityTxt" runat="server"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Required Field " ControlToValidate="cityTxt"></asp:RequiredFieldValidator></td></tr>
                        <tr style="height:55px"><td>State</td><td style="height:40px"><asp:TextBox style="height:40px" ID="stateTxt" runat="server"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Required Field " ControlToValidate="stateTxt"></asp:RequiredFieldValidator></td></tr>
                        <tr style="height:55px"><td>Zip Code</td><td style="height:40px"><asp:TextBox style="height:40px" ID="zipTxt" runat="server"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Required Field" ControlToValidate="zipTxt"></asp:RequiredFieldValidator></td></tr>
        <tr><td colspan="2"><center><asp:Button  ID="Button1" runat="server" Text="Proceed" OnClick="Button1_Click" />
               </center> </td></tr>
        </table>
