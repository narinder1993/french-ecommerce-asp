...
public partial class single : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       // try{
        ...
        if (con.State == System.Data.ConnectionState.Closed)
            con.Open();
        SqlCommand cmd8 = new SqlCommand("select nameEng, price, descEng, sizes from products where Id like '"+id+"'", con);
        ...
        foreach (System.Data.DataRow dr in ds.Tables[0].Rows)
        {
            ...
            cstext2.Append("document.getElementById('button').innerHTML='<a href=\\'#\\' onclick=\\'cart(\"" + id + "\", " + dr[1].ToString() + ", "+qty.Text+")\\' style=\\'height:62px; border-style:groove; width:117px; text-align:center\\' class=\\'add-cart item_add\\'><br />ADD TO CART</a>';");
        ...
        SqlCommand cmd12 = new SqlCommand("select top 3 id, nameEng, ctgEng, price, image1 from  products order by newid()", con);
        ...
        foreach (System.Data.DataRow dr in ds3.Tables[0].Rows)
        {
						...
						cstext2.Append("</div>");
						cstext2.Append("<p class=\"tun\">"+dr[1].ToString()+"</p>");
