	...
	<div class="header-top">
		<div class="container">
			...
			<div class="header-left">		
					<ul id="loginButton">
						<li ><a href="login.aspx"  >Login</a><a href="register.aspx"  >Register</a></li>
...
<!---->
		...
		<ul class="menu">
		    <li class="item1"><a href="category.aspx?category=vest&page=1" >Vests</a></li>
            <li class="item1"><a href="category.aspx?category=jean&page=1">Jeans</a></li>
            <li class="item1"><a href="category.aspx?category=robes&page=1">Robes</a></li>
            <li class="item1"><a href="category.aspx?category=Top&page=1">Tops</a></li>
		</ul>
					</div>
				<!--initiate accordion-->
...
<!---->
	<div class="product-middle">
					...
					<div class="fit-top">
						<h6 class="shop-top">LATEST ADDITIONS</h6>
						<a href="index.aspx" class="shop-now">SHOP NOW</a>
<div class="clearfix"> </div>
	</div>
				</div>	 
