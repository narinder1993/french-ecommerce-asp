...
public partial class OrderV : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd50 = new SqlCommand("select count(shipping) from cart where custId like '"+custId.Value.ToString()+"' and productId is not null and shipping=0", con);
    ...
    public void mail()
    {
        try
        {
            ...
            mailMessage.From = new MailAddress("mayesfashion@gmail.com", "Maye's Fashion Mailer");
            mailMessage.Subject = "New Order at Mayes.fr";
            ...
            cstext2.Append("Congratulations!! You have successfully placed your order at Mayes.fr\nFollowing are the order details:");
            float price = 0;
            foreach (System.Data.DataRow dr in ds.Tables[0].Rows)
            {
                 price += (Convert.ToInt16(dr[3]) * Convert.ToInt16(dr[2]));
                 cstext2.Append("\n\nProduct Id: " + dr[0].ToString() + "\nProduct Name: " + dr[5].ToString() + "\nProduct Size: " + dr[1].ToString() + "\nProduct Quantity: "+dr[2].ToString()+"\nProduct Price: " + dr[3].ToString() + "\nShipping Charges: " + dr[4].ToString() + "\nOrder Date: "+dr[6].ToString()+"");
            }
