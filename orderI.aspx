<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orderI.aspx.cs" Inherits="orderI" %>
...
<li class=" ">Shipping Information</li>
    ...
    <div class="container">
		...
		<div class="col-md-8 account-top" style="width: 56.66666667%;">
			...
			<div> 
                ...
                <p> <br /> <br />If you do not have an account, <a href="register.aspx">register here</a></p>
			</form>
		</div >
      <div id="facebook"><br /><br />
            <h4>You can also login using Facebook</h4>
				<div style="margin-top:4%" class="fb-login-button" data-max-rows="1" data-size="xlarge" data-show-faces="true" data-auto-logout-link="true"></div>
                </div>
	<div class="clearfix"> </div>
	</div>
	</div>
