...
public partial class OrderIV : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cstext2.Clear();
        SqlCommand cmd10 = new SqlCommand("select a.productId, a.size, a.prodQty, a.price, b.nameEng, b.image1 from cart a join products b  on a.productId =b.Id where a.custId like '" + custId.Value + "' ", con);
        ...
        foreach (System.Data.DataRow dr in ds.Tables[0].Rows)
        {
            ...
            cstext2.Append("</div>");
            cstext2.Append(" <div class='cart-item-info'style='text-align:left'>");
