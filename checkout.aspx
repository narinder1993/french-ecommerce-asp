...
<div class="container">
	<div class="check">	 
			 <h1 id="count">My Shopping Bag </h1>
    ...
    $('.close2').on('click', function (c) {
        $('.cart-header2').fadeOut('slow', function (c) {
		  ...
		  <div class="col-md-3 cart-total">
			 <a class="continue" href="index.aspx">Continue to products</a>
			 <div class="price-details">
				 ...
				 <span class="total1">&euro;0.00</span>
				 <div class="clearfix"></div>				 
			 </div>	
			 ...
			 <div class="clearfix"></div>
			 <div id="orderButton"><a class="order" href="#">Place Order</a></div>
