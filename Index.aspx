...
div#slider figure { 
  ...
  animation: 30s slidy infinite; 
	...
	<div class="banner" style="height:600px; overflow:hidden">
		 <div id="slider">
<figure >
...
<div class="content">
	...
	<div class="content-top"> 
		<h1>NEW RELEASED</h1> <h2>UPDATED ON <asp:Label ID="date" runat="server"></asp:Label></h2></form>
	...
	<div class="content-top-bottom">
		...
		<div class="col-md-6">
			<div class="col-md1 ">
				<a href="category.aspx?category=vest&page=1" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive" src="images/t2.jpg" alt="">
					<div class="b-wrapper">
			...
			<div class="col-md2">
				<div class="col-md-6 men1">
					<a href="category.aspx?category=tops&page=1" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive" src="images/t3.jpg" alt="">
							<div class="b-wrapper">
