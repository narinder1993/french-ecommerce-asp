...
<html>
<head>
<title>New Store A Ecommerce Category Flat Bootstrap Responsive Website Template | Blog :: w3layouts</title>
							...
							<div class="col1">
								<div class="h_nav">
									<ul style="font-size:large; margin-left:20px"><center>
										...
										<li><a href="products.aspx">Sweatshirts</a></li>
										<li><a href="products.aspx">Shirts</a></li>
										<li><a href="products.aspx">Tops</a></li>
										<li><a href="products.aspx">Dresses</a></li>
										<li><a href="products.aspx">Pants</a></li></center>
									</ul>	
								</div>						
							</div>
	...
	<h1>Blog</h1>
	       <div class="blog-top">
			  <div class="col-md-6 grid_3">
					...
					<div class="button"><a href="blog_single.aspx">Read More</a></div>
				</div>
				<div class="col-md-6 grid_3">
					<h3><a href="blog_single.aspx">Lorem Ipsum is simply</a></h3>
