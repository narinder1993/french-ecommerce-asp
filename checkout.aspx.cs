...
public partial class checkout : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            cstext2.Clear();
            SqlCommand cmd10 = new SqlCommand("select CONCAT('''',a.productId,''''), a.size, a.prodQty, a.price, b.nameEng, b.image1 from cart a join products b  on a.productId =b.Id where a.custId like '" + custId.Value + "' ", con);
            ...
            foreach (System.Data.DataRow dr in ds.Tables[0].Rows)
            {
                ...
                cstext2.Append(" <p>Price : &euro;" + dr[3].ToString() + "</p>");
                //cstext2.Append(" <span>Delivered in 2-3 bussiness days</span>");
            ...
            cstext2.Append(" document.getElementById('count').innerHTML = 'My Shopping Bag (" + x + ")';");
            ...
            if (name.Value.Equals("Guest User "))
                cstext2.Append(" document.getElementById('orderButton').innerHTML = \"<a class='order' href='orderI.aspx'>Place Order</a>\";");
            else
                cstext2.Append(" document.getElementById('orderButton').innerHTML = \"<a class='order' href='orderII.aspx'>Place Order</a>\";");
            cstext2.Append("}<");
