...
public partial class Index : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       // try{
        ...
        SqlCommand cmd10 = new SqlCommand("select top 3 id, nameEng, image1, price from products where ctgEng like 'robes' and image1 not like 'images/img/no.jpg' order by newid()", con);
        ...
        foreach (System.Data.DataRow dr in ds3.Tables[0].Rows)
        {
			...
			cstext2.Append("<span><br /><br />ROBES SPECIAL: <br>BUY NOW</span>	");
			cstext2.Append("</h3>");
			cstext2.Append("</div>");
			cstext2.Append("</a>");
        ...
        SqlCommand cmd11 = new SqlCommand("select top 3 id, nameEng, image1, price from products where ctgEng like 'vest' and image1 not like 'images/img/no.jpg'  order by newid()", con);
        ...
        foreach (System.Data.DataRow dr in ds4.Tables[0].Rows)
        {
            ...
            cstext2.Append("<div class=\"b-wrapper\">");
            cstext2.Append("<h3 class=\"b-animate b-from-left    b-delay03 \" style=\"min-height:475px\">");
            cstext2.Append("<span><br /><br />VESTS SPECIAL: <br>BUY NOW</span>	");
            cstext2.Append("</h3>");
            cstext2.Append("</div>");
            cstext2.Append("</a>");
            cstext2.Append("<p><a href=\"single.aspx?id=" + dr[0] + "\">" + dr[1].ToString() + " &euro;" + dr[3].ToString() + "</a></p>");
        ...
        SqlCommand cmd12 = new SqlCommand("select top 3 id, nameEng, image1, price from products where ctgEng like 'jean' and image1 not like 'images/img/no.jpg'  order by newid()", con);
        ...
        foreach (System.Data.DataRow dr in ds5.Tables[0].Rows)
        {
            ...
            cstext2.Append("<div class=\"b-wrapper\">");
            cstext2.Append("<h3 class=\"b-animate b-from-left    b-delay03 \" style=\"min-height:475px\">");
            cstext2.Append("<span><br /><br />JEANS SPECIAL: <br>BUY NOW</span>	");
            cstext2.Append("</h3>");
            cstext2.Append("</div>");
            cstext2.Append("</a>");
            cstext2.Append("<p><a href=\"single.aspx?id=" + dr[0] + "\">" + dr[1].ToString() + " &euro;" + dr[3].ToString() + "</a></p>");
        ...
        SqlCommand cmd13 = new SqlCommand("select top 3 id, nameEng, image1, price from products where ctgEng like 'top' and image1 not like 'images/img/no.jpg'  order by newid()", con);
        ...
        foreach (System.Data.DataRow dr in ds6.Tables[0].Rows)
        {
            ...
            cstext2.Append("<div class=\"b-wrapper\">");
            cstext2.Append("<h3 class=\"b-animate b-from-left    b-delay03 \" style=\"min-height:475px\">");
            cstext2.Append("<span><br /><br />TOPS SPECIAL: <br>BUY NOW</span>	");
            cstext2.Append("</h3>");
            cstext2.Append("</div>");
            cstext2.Append("</a>");
            cstext2.Append("<p><a href=\"single.aspx?id=" + dr[0] + "\">" + dr[1].ToString() + " &euro;" + dr[3].ToString() + "</a></p>");
