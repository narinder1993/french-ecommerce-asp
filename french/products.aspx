...
<!---->
		...
		<ul class="menu">
		    <li class="item1"><a href="category.aspx?category=vest&page=1" >Gilets</a></li>
            <li class="item1"><a href="category.aspx?category=jean&page=1">Jeans</a></li>
            <li class="item1"><a href="category.aspx?category=robes&page=1">Peignoir</a></li>
...
<!---->
	<div class="product-middle">
					...
					<div class="fit-top">
						<h6 class="shop-top">Nouveautés</h6>
