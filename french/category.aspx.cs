         ...
         protected void Page_Load(object sender, EventArgs e)
         {
             try
             {
                 ...
                 try
                 {
                     ...
                     System.Data.SqlClient.SqlCommand cmd8 = new System.Data.SqlClient.SqlCommand(";with A aS(SELECT  id, nameFrn, ctgEng, descFrn, price, image1 isAvlbl, sizes,ROW_NUMBER() OVER (ORDER BY Id) AS 'RN' from products where ctgEng like '" + cat + "' )	select * from A ", con);
