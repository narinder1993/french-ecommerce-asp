...
<html>
<head>
<title>Contact Us- Maye Store</title>
...
<div class="contact">
			...
			<div class="contact-form">
				...
				<div style="
    margin-left: 17%;
" class="col-md-8 contact-grid">
						 <asp:TextBox  runat="server" id="names" value="Nom" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='Nom';}"></asp:TextBox>
						<asp:TextBox  runat="server" value="Email" id="email" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='Email';}"></asp:TextBox>
                        <asp:TextBox   runat="server" value="Sujet" id="subject" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='Assujettir';}"></asp:TextBox>
