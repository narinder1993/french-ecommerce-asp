...
public partial class Index1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        foreach (System.Data.DataRow dr in ds3.Tables[0].Rows)
        {
            ...
            cstext2.Append("<a href=\"french/single.aspx?id=" + dr[0] + "\" class=\"b-link-stripe b-animate-go  thickbox\"><img class=\"img-responsive\" src=\"" + dr[2].ToString() + "\" alt=\"\">");
            ...
            cstext2.Append("</div>");
            cstext2.Append("</a>");
            cstext2.Append("<p><a href=\"french/single.aspx?id=" + dr[0] + "\">" + dr[1].ToString() + " &euro;"+dr[3].ToString()+"</a></p>");
            cstext2.Append("</div>");
        }
