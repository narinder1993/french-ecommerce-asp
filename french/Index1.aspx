 ...
 <script type="text/javascript">
     ...
     function logout() {
         ...
         ({
             ...
             dataType: "json",
             success: function () { alert("Logout Successfull"); window.location.href = "french/login.aspx" },
	...
	<div class="header-top"  >
		<div >
			...
			<div class="header-left">		
					<ul id="loginButton">
						<li ><a href="french/login.aspx"  >S'identifier</a><a href="french/register.aspx"  >Registre</a></li>

					</ul>
					<div class="cart box_1">
						<a href="french/checkout.aspx">
						<h3> <div class="total">
		...
		<div class="container">
			<div class="head-top">
				<div class="logo">
					<a href="french/index.aspx"><img src="images/logo.png" alt=""></a>	
				</div>
		  <div class=" h_menu4">
				<ul class="memenu skyblue">
					  <li class="active grid"><a class="color2"  href="french/index.aspx">Home</a></li>	
							...
							<div class="col1">
								<div class="h_nav">
									<ul style="font-size:large; margin-left:20px"><center>
										<li><a href="french/category.aspx?category=vest&page=1" >Gilets</a></li>
										<li><a href="french/category.aspx?category=jean&page=1">Jeans</a></li>
										<li><a href="french/category.aspx?category=robes&page=1">Peignoir</a></li>
										<li><a href="french/category.aspx?category=Top&page=1">Tops</a></li>
			    ...
			    </li><li class="active grid"><a class="color2"  href="french/products.aspx">	Produits</a></li>	
				 <li><a class="color2"  href="french/contact.aspx">Contact</a></li>
			  </ul> 
			</div>
