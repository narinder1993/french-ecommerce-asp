	...
	<h1>Registre</h1>
				 ...
				 <div class="col-md-6 register-top-grid">
					<h3>INFORMATION PERSONNELLE</h3>
					 <div>
						<span>Prénom <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox3" ErrorMessage="Please fill First Name" ForeColor="Red"></asp:RequiredFieldValidator>
                         </span>
					 ...
					 <div>
						<span>
                         Nom de famille <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2" ErrorMessage="Please fill Last Name" ForeColor="Red"></asp:RequiredFieldValidator>
                        </span>
				     ...
				     <div class="col-md-6 register-bottom-grid">
						    <h3>Informations de connexion</h3>
							 <div>
								<span>Mot de passe<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBox4" ErrorMessage="Please set a password" ForeColor="Red"></asp:RequiredFieldValidator>
							 </span>
								<asp:TextBox ID="TextBox4" style="width:540px; height:50px" runat="server" TextMode="Password"></asp:TextBox>
							     <br />
                                 </div>
							 <div>
								<span>Confirmez le mot de passe</span><br />
