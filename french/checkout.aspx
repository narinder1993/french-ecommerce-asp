...
<html>
<head>
<title>Checkout- Maye Store</title>
...
<script src="js/simpleCart.min.js"> </script>
 ...
 <script type="text/javascript">
     ...
     function logt() {
        ...
        function delet(id, qty)
        {
           var id = { "id": id, "qty": qty };
           $.ajax
               ({
                   type: "POST",
                   url: "checkout.aspx/cartDel",
                   data: JSON.stringify(id),
                   contentType: "application/json; charset=utf-8",
                   dataType: "json",
                   success: function () { window.location.href = 'checkout.aspx';}
               });
        }
    </script>
    ...
    $('.close2').on('click', function (c) {
        $('.cart-header2').fadeOut('slow', function (c) {
		  ...
		  <div class="col-md-3 cart-total">
			 <a class="continue" href="index.aspx">Ajouter un product</a>
			 ...
			 <div class="clearfix"></div>
			 <div id="orderButton"><a class="order" href="orderI.aspx">Passer la commande</a></div>
