...
<li class="previous visited">Informations sur la livraison</li>
<li class="active">Les options d'expédition</li>    
<li class="next">Critique et conditions</li>   
<li class="">Achevée</li>  
</div> <br /><br /><br /><br /><br /><br />
 <div>
     <center><h3>S'il vous plaît sélectionnez votre zone d'expédition</h3>
         <h5>(Applicable par article)</h5>
      </center>
     <br /><br /> 
     <fieldset style="font-size:large; margin-left:7%">
         <asp:RadioButtonList ID="RadioButtonList1" AutoPostBack="true" runat="server" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged1">
             <asp:ListItem Value="1">Zone 1: En France</asp:ListItem>
             <asp:ListItem Value="2">Zone 2: Guadeloupe (y compris Saint Barthélémy et St Martin), Martinique, Réunion,
Guyane, Mayotte et Saint Pierre et Miquelon</asp:ListItem>
             <asp:ListItem Value="3">Zone 3: Nouvelle-Calédonie et dépendances, Polynésie française, Wallis-et-
Futuna, française Terres australes et antarctiques</asp:ListItem>
             <asp:ListItem Value="4">Zone 4: Allemagne, Belgique, Pays-Bas,
Luxembourg.</asp:ListItem>
             <asp:ListItem Value="5">Zone 5: Royaume-Uni, Irlande, Italie,
Espagne, Portugal, Suisse, Autriche</asp:ListItem>
             <asp:ListItem Value="6">Zone 6: Danemark, la Hongrie, la Pologne,
République tchèque, Slovaquie, Slovénie,
L'Estonie, la Lettonie, la Lituanie</asp:ListItem>
             <asp:ListItem Value="7">Zone 7: La Grèce, l'Islande, la Finlande, la Norvège,
La Suède, la Turquie, le Maghreb,
Portugal et l'Espagne, Europe de l'Est.</asp:ListItem>
             <asp:ListItem Value="8">Zone 8: USA, Canada, Australie,
Chine, le Japon, Hong Kong, Singapour,
Corée du Sud, la Thaïlande, Taïwan, Viet
Nam, l'Inde, la Russie, Israël</asp:ListItem>
             <asp:ListItem Value="9">Zone 9: Afrique (hors Afrique du Nord), le Moyen-Orient,
Amériques, d'autres pays d'Asie, d'Océanie.</asp:ListItem>
              
         </asp:RadioButtonList>
     <br /><br /><br /> <p>Your shipping charges are:&euro;<asp:Label ID="ship" runat="server" Text="0"></asp:Label></p>
       <center>  <asp:Button ID="Button1" CssClass="btn" style="border:groove" runat="server" Text="Continuer" OnClick="Button1_Click" />
         </center>
     </fieldset>  </form>
 </div>  
	<!---->
