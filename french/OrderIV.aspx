<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderIV.aspx.cs" Inherits="OrderIV" %>
<!DOCTYPE html>
<html>
<head>
...
<li class="visited first">Informations sur la livraison</li>
<li class="visited first">Les options d'expédition</li>    
<li class="active">Critique et conditions</li>   
<li class="">Achevée</li>  
</ul>
</div>
    <br /><br /><br /><br />
    <div class="account"><center>
        <div class="check" style="width:75%">	 
			 <h1 id="count">Mon sac à provisions </h1>
        ...
        $('.cart-header2').fadeOut('slow', function (c) {
		    ...
		    <div class="col-md-3 cart-total">
			   <div class="price-details">
                 ...
                 <div class="clearfix"></div>	
				 <span>Total</span>
				 <span class="total1" id="total1">&euro;</span>
				  
				 <span>Coûts de livraison</span>
				 <span class="total1" id="ship">&euro;0</span>
				 <div class="clearfix"></div>				 
			 </div>	
			 <ul class="total_price">
			   <li class="last_price"> <h4>TOTAL</h4></li>	
			   <li class="last_price"><span id="total2">&euro;</span></li>
			   <div class="clearfix"> </div>
			 </ul>
			 ...
			 <div class="clearfix"></div>
                <div><br />
                  <asp:CheckBox ID="CheckBox1"   runat="server"> </asp:CheckBox>En cochant cette case, vous vous engagez avec le <a href="javascript:window.open('policy.aspx','mywindowtitle','width=500,height=150')">politique de remboursement</a> Collections de Maye.
                </div>
                <script>
                    function check()
                    {
                        ...
                        else { alert("S'il vous plaît accepter les termes et conditions.") }
                    }

                </script>
                <div id="orderButton"><a  onclick="check()"><img src="https://www.paypal.com/fr_XC/i/btn/btn_xpressCheckout.gif" align="left" style="margin-right:7px;"></a></div>
